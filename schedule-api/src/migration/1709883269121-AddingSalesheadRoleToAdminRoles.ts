...
export class AddingSalesheadRoleToAdminRoles1709883269121 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<void> {
        // Add a new temporary column with the updated enum values
        await queryRunner.query(
          `ALTER TABLE admin ADD COLUMN role_temp ENUM('admin', 'superadmin', 'teacher', 'zoom', 'programmanager', 'pmhead', 'sales', 'saleshead')`
        );
