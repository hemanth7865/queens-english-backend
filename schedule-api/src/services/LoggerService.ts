...
export default class LoggerService {
    ...
    public payment(oldRecord: {transaction: Transactions, transactionDetails: TransactionDetails}, newRecord: {transaction: Transactions, transactionDetails: TransactionDetails}, user: object) {
        this.page = "payments";
        this.logData = {
