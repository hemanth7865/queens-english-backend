export default {
  ...
  'pages.welcome.alertMessage': 'Test alert.',
  ...
  'pages.searchTable.school.batchesNumber': 'No. Of Batches',
  'pages.searchTable.school.sra': 'SRA',
  'pages.searchTable.school.status': 'Status',
  'pages.searchTable.school.status.active': 'Active',
  'pages.searchTable.school.status.inactive': 'Inactive',
