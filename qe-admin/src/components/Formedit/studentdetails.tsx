...
const Studentdetailsedit: React.FC<StudentdetailseditProps> = (props) => {
  ...
  const onFinish = (value: any) => {
    const dataForm = {
      ...
      startDate: props.studentManageradd ? null : value.startDate ? moment(value.startDate, "YYYY-MM-DD").format("YYYY-MM-DD") : '',
      classesStartDate: props.studentManageradd ? null : value.classesStartDate ? moment(value.classesStartDate, "YYYY-MM-DD").format("YYYY-MM-DD") : null,
      ...
      payment: !props.studentManageradd ? [{
        ...
        dateofsale: (moment(value.dateofsale).toISOString(true).split('T')[0]),
        dueDate: (moment(value.duedate).toISOString(true).split('T')[0]),
