...
const Studentdetailsedit: React.FC<StudentdetailseditProps> = (props) => {
  ...
  const onFinish = (value: any) => {
    const dataForm = {
      ...
      dob: !value.dob ? null : moment(value.dob, "YYYY-MM-DD").format("YYYY-MM-DD"),
      ...
      startDate: props.studentManageradd || !value.startDate ? null : moment(value.startDate, "YYYY-MM-DD").format("YYYY-MM-DD"),
      classesStartDate: props.studentManageradd || !value.classesStartDate ? null : moment(value.classesStartDate, "YYYY-MM-DD").format("YYYY-MM-DD"),
      ...
      payment: !props.studentManageradd ? [{
        ...
        dateofsale: !value.dateofsale ? null : (moment(value.dateofsale).toISOString(true).split('T')[0]),
        dueDate: !value.duedate ? null : (moment(value.duedate).toISOString(true).split('T')[0]),
