    ...
    },
    {
      ...
      render: (value) => {
        return (
          <a
            onClick={() => {
              openNotification('info', value.phoneNumber, value.courseFrequency, value.timings, value.zoomLink, value.prm_firstName, value.prm_lastName, value.classesStartDate, value.zoomInfo, value.batchCode, value.whatsappLink, value.classCode, value.useNewZoomLink, value.userCode, value.useAutoAttendance)
            }}
          >
            <EyeOutlined />
          </a>)
